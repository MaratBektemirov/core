...
4) In `src/app/index.module.ts` add underneath the other import statements: `import '../styles/styles.scss';`
...
* Where do I write my tests?
  * You can write your tests next to your component files. See [`/src/app/home/search.component.spec.ts`](/src/app/search/search.component.spec.ts)
...
```
sudo apt-get update
sudo apt-key adv --keyserver hkp://p80.client.sks-keyservers.net:80 --recv-keys 58118E89F3A912897C070ADBF76221572C52609D
